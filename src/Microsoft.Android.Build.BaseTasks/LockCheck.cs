// From: https://github.com/dotnet/msbuild/blob/7cf66090a764f0f239671e4877255efe7ba91155/src/Utilities/LockCheck.cs
...
using Microsoft.Android.Build.Tasks.Properties;
...
namespace Microsoft.Build.Utilities
{
	...
	public static class LockCheck
	{
		...
		private static string GetProcessesLockingFile (string filePath)
		{
		...
		private static string GetLockedFileMessageWindows (string filePath)
		{
			...
			try {
				...
				message = !string.IsNullOrEmpty (processes)
					? string.Format (Resources.LockCheck_FileLocked, filePath, processes)
					: String.Empty;
			} catch (Exception) {
		...
		private static IEnumerable<ProcessInfo> GetLockingProcessInfos (params string [] paths)
		{
			if (paths == null) {
